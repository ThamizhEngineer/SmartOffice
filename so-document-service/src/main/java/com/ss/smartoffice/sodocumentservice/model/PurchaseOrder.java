...
public class PurchaseOrder {
	...
	public PurchaseOrder(Integer id, Integer vendorId, String vendorName, String vendorCode, String poCode, Date poDt,
			Double grossPoAmt, Double totalTaxAmt, Double totalDiscountAmt, Double netPoAmt, Double totalPaidAmt,
			Double totalDueAmt, String poNote, String poStatus, String poRefNumber, String refType, String poName,
			String billingRemarks, String address, String phoneNumber, String emailId, Double cgst, Double sgst,
			Double igst, Double totalShippingAmt, Double otherAmt, String supplierRefNumber, String otherRefNumber,
			String despatchThrough, String destination, String deliveryTerms, String vendorTinNumber,
			String vendorPanNumber, String docId, String emailSubject, String emailBody,
	...
	public String toString() {
		return "PurchaseOrder [id=" + id + ", vendorId=" + vendorId + ", vendorName=" + vendorName + ", vendorCode="
				...
				+ ", deliveryTerms=" + deliveryTerms + ", vendorTinNumber=" + vendorTinNumber + ", vendorPanNumber="
				+ vendorPanNumber + ", docId=" + docId + ", emailSubject=" + emailSubject + ", emailBody=" + emailBody
