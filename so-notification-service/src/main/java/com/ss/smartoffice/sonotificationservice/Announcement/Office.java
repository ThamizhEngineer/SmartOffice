...
public class Office {
	...
	public Office(int id, String officeName, String description, String countryCode, String employeeId, String empName,
			Integer countryId, String shiftId, String shiftName, String shiftFromTime, String shiftToTime,
			String officeAbbreviation, String lastEmpSequence, String isEnabled, String createdBy, String modifiedBy,
	...
	public String toString() {
		return "Office [id=" + id + ", officeName=" + officeName + ", description=" + description + ", countryCode="
				...
				+ lastEmpSequence + ", isEnabled=" + isEnabled + ", createdBy=" + createdBy + ", modifiedBy="
