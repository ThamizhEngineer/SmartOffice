...
public class Employee {
	...
	@Formula("(SELECT desig.desig_name FROM s_designation desig WHERE desig.id = designation_id)")
...
private Set<LocationSeed> employeeLocations = new HashSet<>();
	...
	public Employee(Integer id, String empName, String empCode, String loginUserId, String tempContactNo,
			...
			String officeChange, LocalDateTime startDt, LocalDateTime endDt, String contactMobileNo,
			String contactEmailId, Integer officeId, Integer countryId, String isEnabled, String createdBy,
			String modifiedBy, Integer deptId, String deptName, String deptCode, List<LanguagesKnown> languages,
			...
			LocalDateTime createdDt, LocalDateTime modifiedDt, String pfNo, String uanNo, String relaContNo2,
			String relaEmailId, String prePfNo, String preEsiNo, String preUanNo, String drivLicDocId, String passDocId,
			String addrProofDocId, String panCheck, String adCheck, String addrPrCheck, String passCheck,
			String drivLicCheck, String empCategory) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Employee [id=" + id + ", empName=" + empName + ", empCode=" + empCode + ", loginUserId=" + loginUserId
				...
				+ ", aadharNo=" + aadharNo + ", n1EmpId=" + n1EmpId + ", managerName=" + managerName
				+ ", defaultAttendanceCode=" + defaultAttendanceCode + ", n2EmpId=" + n2EmpId + ", reviewManagerName="
				+ reviewManagerName + ", hr1UsrGrpId=" + hr1UsrGrpId + ", hr1UsrGrpName=" + hr1UsrGrpName
				+ ", hr2UsrGrpId=" + hr2UsrGrpId + ", hr2UsrGrpName=" + hr2UsrGrpName + ", acc1UsrGrpId=" + acc1UsrGrpId
				...
				+ ", skillValidateRemarks=" + skillValidateRemarks + ", internalId=" + internalId + ", remarks="
				+ remarks + ", gradeId=" + gradeId + ", gradeName=" + gradeName + ", gradeOrder=" + gradeOrder
				+ ", designationId=" + designationId + ", gender=" + gender + ", isBillable=" + isBillable
				+ ", firstName=" + firstName + ", lastName=" + lastName + ", desigName=" + desigName + ", empTypeCode="
				+ empTypeCode + ", docId=" + docId + ", docName=" + docName + ", panDocId=" + panDocId
				+ ", aadharDocId=" + aadharDocId + ", passBookDocId=" + passBookDocId + ", contractorCode="
				+ contractorCode + ", officeChange=" + officeChange + ", startDt=" + startDt + ", endDt=" + endDt
				+ ", contactMobileNo=" + contactMobileNo + ", contactEmailId=" + contactEmailId + ", officeId="
				+ officeId + ", countryId=" + countryId + ", isEnabled=" + isEnabled + ", createdBy=" + createdBy
				+ ", modifiedBy=" + modifiedBy + ", deptId=" + deptId + ", deptName=" + deptName + ", deptCode="
				+ deptCode + ", languages=" + languages + ", employeeSkills=" + employeeSkills + ", familyInfo="
				+ familyInfo + ", educationalInfo=" + educationalInfo + ", academicAcheiv=" + academicAcheiv
				+ ", previousEmployDetails=" + previousEmployDetails + ", employeecc=" + employeecc + ", bankDetails="
				+ bankDetails + ", employeeLocations=" + employeeLocations + ", createdDt=" + createdDt
				+ ", modifiedDt=" + modifiedDt + ", pfNo=" + pfNo + ", uanNo=" + uanNo + ", relaContNo2=" + relaContNo2
				+ ", relaEmailId=" + relaEmailId + ", prePfNo=" + prePfNo + ", preEsiNo=" + preEsiNo + ", preUanNo="
				+ preUanNo + ", drivLicDocId=" + drivLicDocId + ", passDocId=" + passDocId + ", addrProofDocId="
				+ addrProofDocId + ", panCheck=" + panCheck + ", adCheck=" + adCheck + ", addrPrCheck=" + addrPrCheck
				+ ", passCheck=" + passCheck + ", drivLicCheck=" + drivLicCheck + ", empCategory=" + empCategory + "]";
	}
