...
public class Customer {
	...
	public Customer(Integer id, String clientCode, String clientName, String mobileNo, String emailId,
			String vendorCode, String vendorAbbreviation, String priContactName, String country, String isEnabled,
	...
	public String toString() {
		return "Customer [id=" + id + ", clientCode=" + clientCode + ", clientName=" + clientName + ", mobileNo="
