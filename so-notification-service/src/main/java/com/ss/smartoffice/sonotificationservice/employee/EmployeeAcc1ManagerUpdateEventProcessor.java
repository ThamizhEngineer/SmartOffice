...
//@Service
//public class EmployeeAcc1ManagerUpdateEventProcessor {
//	@Value("${employees.url}")
//	private String employeeUrl;
//	@Autowired
//	CommonUtils commonUtils;
//	@Autowired
//	EmployeeAcc1ManagerUpdateService employeeAcc1ManagerUpdateService;
//
//	public void processEmployeeAcc1Update(Event event) {
//		try {
...
//
//				try {
//					employeeAcc1ManagerUpdateService.updateAcc1ManagerToSelectedEmp(employee);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			} else {
