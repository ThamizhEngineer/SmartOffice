...
//@Service
//public class EmployeeHr1ManagerUpdateEventProcessor {
//	@Value("${employees.url}")
//	private String employeeUrl;
//	@Autowired
//	CommonUtils commonUtils;
//	@Autowired
//	EmployeeHr1ManagerUpdateService employeeHr1ManagerUpdateService;
//
//	public void processEmployeeHr1Update(Event event) {
//		try {
...
//						Employee.class);
//				try {
//					employeeHr1ManagerUpdateService.updateHr1ManagerToSelectedEmp(employee);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			} else {
