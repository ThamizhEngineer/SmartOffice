...
@Service
public class EmployeeHr1ManagerUpdateService {
	private static final String EMAIL_HR1_UPDATE_TEMPLATE_NAME="html/employee-hr1-update";
	@Autowired
	SmsHelper smsHelper;
	...
	public void updateHr1ManagerToSelectedEmp(Employee employee) {
		try {
			...
			final String htmlContent= this.htmlTemplateEngine.process(EMAIL_HR1_UPDATE_TEMPLATE_NAME, ctx);
