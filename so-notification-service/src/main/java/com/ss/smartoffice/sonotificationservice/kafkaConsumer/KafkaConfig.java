...
public class KafkaConfig {
	...
	public ConsumerFactory<String, String> consumerStringFactory(){
		...
		config.put(ConsumerConfig.GROUP_ID_CONFIG, "so-notification-service-consumer");
	...
	public ConsumerFactory<String, Event> consumerFactory(){
		...
		config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ss.smartoffice.shared.model.event.Event");
