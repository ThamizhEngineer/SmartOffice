...
@Service
public class TestFailEmailProcess {
	...
	private static final String TEST_FAIL_TEMPLATE = "html/test-fail-email";
...
//		
//			message.setFrom("helpdesk.sidsync@gmail.com");
//			
//			
//			
//			
...
//			final String htmlContent1 = this.htmlTemplateEngine.process(TEST_FAIL_TEMPLATE, ctx);
