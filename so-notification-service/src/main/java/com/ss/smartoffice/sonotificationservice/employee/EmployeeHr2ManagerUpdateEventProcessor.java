...
//@Service
//public class EmployeeHr2ManagerUpdateEventProcessor {
//	@Value("${employees.url}")
//	private String employeeUrl;
//	@Autowired
//	CommonUtils commonUtils;
//	@Autowired
//	EmployeeHr2UpdateService employeeHr2UpdateService;
//	public void processEmployeeHr2Update(Event event) {
//		try {
...
//						Employee.class);
//				try {
//					employeeHr2UpdateService.updateHr2ToSelectedEmp(employee);
//				}catch (Exception e) {
//					e.printStackTrace();
//				}
//			}else {
