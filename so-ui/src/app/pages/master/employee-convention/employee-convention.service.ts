...
@Injectable()
export class EmployeeConventionService {
    ...
    hr1GetEmployee(){
        return this.http.get(environment.serviceApiUrl+'master/emp-profiles/hr1-profile-validate', this.commonService.jwt()).map((response: Response) => response).map(res => res.json());
    }
