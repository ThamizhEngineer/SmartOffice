...
import { OfficeCalendarModule} from './office-calendar/office-calendar.module';
...
//  { path: 'payroll', loadChildren: './payroll/payroll.module#PayrollModule' },
  ...
  { path: 'office-calendar', loadChildren: './office-calendar/office-calendar.module#OfficeCalendarModule' },
