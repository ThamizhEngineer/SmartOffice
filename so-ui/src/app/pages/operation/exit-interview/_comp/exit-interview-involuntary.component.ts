...
@Component({
    selector: 'exit-interview-involuntary',
    templateUrl: './exit-interview-involuntary.component.html'
})
export class ExitInterviewInVoluntaryComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.exitInterview.exitType='involuntary';
