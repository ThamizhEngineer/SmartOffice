...
public class EmployeeCtc extends BaseEntity {
	...
	@JoinColumn(name="m_emp_ctc_id")
	private List<EmployeeCtcLine> employeeCtcLines;
	public EmployeeCtc() {
		super();
		// TODO Auto-generated constructor stub
	}
	public EmployeeCtc(int id, String employeeId, String isActive, LocalDate validFromDt, LocalDate validToDt,
			...
			List<EmployeeCtcLine> employeeCtcLines) {
		super();
		this.id = id;
		...
		this.employeeCtcLines = employeeCtcLines;
	}
	public int getId() {
		return id;
	}
	...
	public List<EmployeeCtcLine> getEmployeeCtcLines() {
		return employeeCtcLines;
	}
	public void setEmployeeCtcLines(List<EmployeeCtcLine> employeeCtcLines) {
		this.employeeCtcLines = employeeCtcLines;
	}
	@Override
	public String toString() {
		return "EmployeeCtc [id=" + id + ", employeeId=" + employeeId + ", isActive=" + isActive + ", validFromDt="
				+ validFromDt + ", validToDt=" + validToDt + ", head1Name=" + head1Name + ", head2Name=" + head2Name
				+ ", head3Name=" + head3Name + ", head4Name=" + head4Name + ", head5Name=" + head5Name + ", head6Name="
				+ head6Name + ", head7Name=" + head7Name + ", head8Name=" + head8Name + ", head9Name=" + head9Name
				+ ", head10Name=" + head10Name + ", head1Total=" + head1Total + ", head2Total=" + head2Total
				+ ", head3Total=" + head3Total + ", head4Total=" + head4Total + ", head5Total=" + head5Total
				+ ", head6Total=" + head6Total + ", head7Total=" + head7Total + ", head8Total=" + head8Total
				+ ", head9Total=" + head9Total + ", head10Total=" + head10Total + ", fixedBenefits=" + fixedBenefits
				+ ", isEnabled=" + isEnabled + ", createdBy=" + createdBy + ", modifiedBy=" + modifiedBy
				+ ", createdDt=" + createdDt + ", modifiedDt=" + modifiedDt + ", employeeCtcLines=" + employeeCtcLines
				+ "]";
	}
