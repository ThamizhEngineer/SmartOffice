...
public class BusinessKey {
	...
	public BusinessKey(Integer id, String eventId, String userId, String employeeId, String internalId,
			String interviewId, String employeeCode, String tarId, String tarCode, String leaveRequestId,
			String leaveRequestCode, String expenseClaimId, String expenseClaimCode, String incidentId,
			String incidentCode, String n1EmpId, String n2EmpId, String hr1UserGroupId, String hr2UserGroupId,
			String hr1EmpId, String hr2EmpId, String acc1UserGroupId, String dirUserGroupId, String dirEmpId,
			String acc2UserGroupId, String acc1EmpId, String acc2EmpId, String uploadPayslipHdrId, String latitudes,
			String longtitudes, String empPayoutId, String clientId, String customerId, String saleOrderId,
			String saleOrderCode, String purchaseOrderId, String purchaseOrderCode, String applicantId,
			String partnerId, String key1, String key2, String key3, String key4, String key5, String key6, String key7,
			String key8, String key9, String key10) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BusinessKey [id=" + id + ", eventId=" + eventId + ", userId=" + userId + ", employeeId=" + employeeId
				+ ", internalId=" + internalId + ", interviewId=" + interviewId + ", employeeCode=" + employeeCode
				+ ", tarId=" + tarId + ", tarCode=" + tarCode + ", leaveRequestId=" + leaveRequestId
				+ ", leaveRequestCode=" + leaveRequestCode + ", expenseClaimId=" + expenseClaimId
				+ ", expenseClaimCode=" + expenseClaimCode + ", incidentId=" + incidentId + ", incidentCode="
				+ incidentCode + ", n1EmpId=" + n1EmpId + ", n2EmpId=" + n2EmpId + ", hr1UserGroupId=" + hr1UserGroupId
				+ ", hr2UserGroupId=" + hr2UserGroupId + ", hr1EmpId=" + hr1EmpId + ", hr2EmpId=" + hr2EmpId
				+ ", acc1UserGroupId=" + acc1UserGroupId + ", dirUserGroupId=" + dirUserGroupId + ", dirEmpId="
				+ dirEmpId + ", acc2UserGroupId=" + acc2UserGroupId + ", acc1EmpId=" + acc1EmpId + ", acc2EmpId="
				+ acc2EmpId + ", uploadPayslipHdrId=" + uploadPayslipHdrId + ", latitudes=" + latitudes
				+ ", longtitudes=" + longtitudes + ", empPayoutId=" + empPayoutId + ", clientId=" + clientId
				+ ", customerId=" + customerId + ", saleOrderId=" + saleOrderId + ", saleOrderCode=" + saleOrderCode
				+ ", purchaseOrderId=" + purchaseOrderId + ", purchaseOrderCode=" + purchaseOrderCode + ", applicantId="
				+ applicantId + ", partnerId=" + partnerId + ", key1=" + key1 + ", key2=" + key2 + ", key3=" + key3
				+ ", key4=" + key4 + ", key5=" + key5 + ", key6=" + key6 + ", key7=" + key7 + ", key8=" + key8
				+ ", key9=" + key9 + ", key10=" + key10 + "]";
	}
