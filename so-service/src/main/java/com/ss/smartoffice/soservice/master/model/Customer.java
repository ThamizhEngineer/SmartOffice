...
public class Customer extends BaseEntity {
	...
	public Customer(int id, String customerCode, String orgName, String contactName, String contactEmail,
			String contactPhone, String headOfficeAddressLine1, String headOfficeAddressLine2, String headOfficeCity,
			String headOfficeState, int headOfficePincode, String headOfficeCountry, String headOfficeNumber,
			String bankAccNo, String bankAccName, String bankAccType, String bankName, String bankBranchName,
			String bankIfscCode, String bankOtherInfo, String gstNo, String tanNo, String panNo, String isEnabled,
			String createdBy, String modifiedBy, String remarks, LocalDateTime createdDt, LocalDateTime modifiedDt) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Customer [id=" + id + ", customerCode=" + customerCode + ", orgName=" + orgName + ", contactName="
				+ contactName + ", contactEmail=" + contactEmail + ", contactPhone=" + contactPhone
				+ ", headOfficeAddressLine1=" + headOfficeAddressLine1 + ", headOfficeAddressLine2="
