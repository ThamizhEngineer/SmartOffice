...
@Table(name = "i_invoice_hdr")
public class IntInvoiceHdr {
	@Id
	...
	public IntInvoiceHdr() {
		super();
		// TODO Auto-generated constructor stub
	}

	public IntInvoiceHdr(Integer id, String uploadDocId, LocalDateTime uploadDate, LocalDateTime processDate,
	...
	public String toString() {
		return "IntInvoiceHdr [id=" + id + ", uploadDocId=" + uploadDocId + ", uploadDate=" + uploadDate
