...
public class CustomOutput {
	...
	public CustomOutput(String op1, String op2, String op3, String op4, String op5, String op6, String op7, String op8,
	...
	public String toString() {
		return "CustomOutput [op1=" + op1 + ", op2=" + op2 + ", op3=" + op3 + ", op4=" + op4 + ", op5=" + op5 + ", op6="
				+ op6 + ", op7=" + op7 + ", op8=" + op8 + ", op9=" + op9 + ", op10=" + op10 + "]";
	}
